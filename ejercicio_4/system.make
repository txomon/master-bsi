...
# C:\Users\Alumno\proyectos\master-bsi\ejercicio_4\system.mhs
# The software specification of the system is in file :
# C:\Users\Alumno\proyectos\master-bsi\ejercicio_4\system.mss
...
program_program: $(CYG_PROGRAM_OUTPUT) 

$(CYG_PROGRAM_OUTPUT) : $(PROGRAM_SOURCES) $(PROGRAM_HEADERS) $(PROGRAM_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/program_compiler.opt
	@mkdir -p $(PROGRAM_OUTPUT_DIR) 
	$(PROGRAM_CC) $(PROGRAM_CC_OPT) $(PROGRAM_SOURCES) -o $(CYG_PROGRAM_OUTPUT) \
	$(PROGRAM_OTHER_CC_FLAGS) $(PROGRAM_INCLUDES) $(PROGRAM_LIBPATH) \
	$(PROGRAM_CFLAGS) $(PROGRAM_LFLAGS) 
	$(PROGRAM_CC_SIZE) $(CYG_PROGRAM_OUTPUT) 
	@echo ""

program_programclean:
	rm -f $(PROGRAM_OUTPUT) 
...
$(PROCESSOR_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(PROCESSOR_BOOTLOOP)

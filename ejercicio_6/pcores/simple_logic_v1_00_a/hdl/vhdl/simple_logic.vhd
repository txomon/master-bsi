------------------------------------------------------------------------------
-- simple_logic - entity/architecture pair
------------------------------------------------------------------------------
--
-- ***************************************************************************
...
--
------------------------------------------------------------------------------
-- Filename:          simple_logic
-- Version:           1.00.a
-- Description:       Example FSL core (VHDL).
-- Date:              Sat Jan 11 16:18:40 2014 (by Create and Import Peripheral Wizard)
...
-- In this section, we povide an example implementation of ENTITY simple_logic
...
-- ENTITY simple_logic to implement your coprocessor

architecture EXAMPLE of simple_logic is
